...
//    NSLog(@"SAVED: %@", [articlesMap description]);
    ...
    // post notification for saved articles
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:kArticleSavedNotification object:nil]];
